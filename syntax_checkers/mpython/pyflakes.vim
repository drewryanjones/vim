...
let g:loaded_syntastic_mpython_pyflakes_checker = 1

let s:save_cpo = &cpo
set cpo&vim

function! SyntaxCheckers_mpython_pyflakes_GetHighlightRegex(i)
...
function! SyntaxCheckers_mpython_pyflakes_GetLocList() dict
